...
import MatchAudience from "./MatchAudience";
  ...
  return (
    <Grid>
      <Stack sx={{ width: "100%", border: "1px solid lightgrey", padding: "20px",paddingBottom:"0px" }}>
        ...
        <Box sx={{display:"flex"}} >
          <Typography><Link sx={{textDecoration:"none",marginRight:"20px"}} >Matched</Link></Typography>
          <Typography><Link sx={{textDecoration:"none"}}>Saved</Link></Typography>
        </Box>
      </Stack>
